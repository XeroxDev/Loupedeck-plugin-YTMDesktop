namespace Loupedeck.YTMDesktopPlugin.Services
{
    ...
    public sealed class SocketService
    {
        ...
        public Subject<TrackAndPlayer> OnTick { get; } = new Subject<TrackAndPlayer>();
        public Subject<String> OnError { get; } = new Subject<String>();
        public Subject<OnConnectedEvent> OnConnected { get; } = new Subject<OnConnectedEvent>();

        public BehaviorSubject<Boolean> IsConnected { get; } = new BehaviorSubject<Boolean>(false);

        private String _host = "127.0.0.1";
        private String _port = "9863";
        private String _password = "";

        private static readonly Lazy<SocketService> Lazy = new Lazy<SocketService>(() => new SocketService());
        ...
        private void SetEvents()
        {
            ...
            this.OnError.Subscribe(reason => this.IsConnected.OnNext(false));
